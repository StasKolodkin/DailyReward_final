...
export const itemsInfo = {
	[ItemId.Balon]: {"Name":"Балончик","Description":"Нужен для зарисовки стен","Icon":"inv-item-balon","Type":"Инструмент","Stack":1,"functionType":0},
	[ItemId.WeaponSkinGift]: {"Name":"Скин на оружие","Description":"Внтури сюрприз, оружие!!!","Icon":"inv-item-gift","Type":"Остальное","Stack":1,"functionType":0},
	...
	[ItemId.Case3]: {"Name":"Автомобильный кейс","Description":"Автомобильный кейс с экзотическими авто.","Icon":"inv-item-case3","Type":"Особое","Stack":100,"functionType":9},
	[ItemId.Case4]: {"Name":"Весенний кейс","Description":"Весенний кейс, есть возможность серьёзно окупиться!","Icon":"inv-item-case4","Type":"Особое","Stack":100,"functionType":9},
	[ItemId.Case5]: {"Name":"Летний кейс","Description":"Летний кейс, есть возможность серьёзно окупиться!","Icon":"inv-item-case5","Type":"Особое","Stack":100,"functionType":9},
	...
	[ItemId.Case7]: {"Name":"CIV Кейс","Description":"Очень лютый кейс с бронежилетами.","Icon":"inv-item-case7","Type":"Особое","Stack":100,"functionType":9},
	[ItemId.Case8]: {"Name":"LSPD Кейс","Description":"Кейс с МУЖСКОЙ одеждой из донатного магазина одежды. Испытай удачу и будь стильным, или продай кому-то и будь богатым. А можешь и подарить...","Icon":"inv-item-case8","Type":"Особое","Stack":100,"functionType":9},
	[ItemId.Case9]: {"Name":"GOS Кейс","Description":"Кейс с ЖЕНСКОЙ одеждой из донатного магазина одежды. Отличный вариант, если хочется что-нибудь подарить.","Icon":"inv-item-case9","Type":"Особое","Stack":100,"functionType":9},
	[ItemId.Case10]: {"Name":"Clothes Кейс [М]","Description":"Кейс с автомобилями из Exotic DonateRoom. Доната Редбаксовна одобряет!","Icon":"inv-item-case10","Type":"Особое","Stack":100,"functionType":9},
	[ItemId.Case11]: {"Name":"Dragon кейс","Description":"Все или ничего! Хочешь рискнуть и стать обладателем легендарной кофты RedAge? Тогда крути кейс!","Icon":"inv-item-case11","Type":"Особое","Stack":100,"functionType":9},
	[ItemId.Case12]: {"Name":"Exotic Weapon кейс","Description":"Давно хочешь себе уникальную машину которая нигде не продается? Dodge Charger в этом кейсике!","Icon":"inv-item-case12","Type":"Особое","Stack":100,"functionType":9},
	[ItemId.Case13]: {"Name":"Sniper кейс","Description":"Любишь смотреть на людей свысока? Пожалуй, для этого идеально подойдет вертолёт!","Icon":"inv-item-case13","Type":"Особое","Stack":100,"functionType":9},
	...
	[ItemId.Candy]: {"Name":"Леденцы","Description":"Ивентовый предмет","Icon":"inv-item-event","Type":"Остальное","Stack":15,"functionType":0},
	[ItemId.ChristmasTreeDecoration]: {"Name":"Елочная игрушка","Description":"Ивентовый предмет","Icon":"inv-item-event","Type":"Остальное","Stack":15,"functionType":0},
	[ItemId.ChristmasTreeStar]: {"Name":"Елочная звезда","Description":"Ивентовый предмет","Icon":"inv-item-event","Type":"Остальное","Stack":15,"functionType":0},
	[ItemId.SmallGift]: {"Name":"Маленький подарок","Description":"Сюрприз","Icon":"inv-item-gift","Type":"Остальное","Stack":1,"functionType":0},
	[ItemId.MediumGift]: {"Name":"Средний подарок","Description":"Сюрприз","Icon":"inv-item-gift","Type":"Остальное","Stack":1,"functionType":0},
	[ItemId.BigGift]: {"Name":"Большой подарок","Description":"Сюрприз","Icon":"inv-item-gift","Type":"Остальное","Stack":1,"functionType":0},
	[ItemId.ArmorGift]: {"Name":"Скин на бронежилет","Description":"Внтури сюрприз, бронежилет!!!","Icon":"inv-item-gift","Type":"Остальное","Stack":1,"functionType":0},
	[ItemId.HairClipper]: {"Name":"Машинка для стрижки","Description":"Машинка для стрижки волос","Icon":"inv-item-gift","Type":"Остальное","Stack":1,"functionType":0},
	[ItemId.Medovuha]: {"Name":"Пиво","Description":"Может сделать вас супергероем!","Icon":"inv-item-improvement","Type":"Бафф","Stack":1,"functionType":10},
	[ItemId.Spank]: {"Name":"Spank","Description":"Может сделать вас супергероем!","Icon":"inv-item-improvement","Type":"Бафф","Stack":10,"functionType":10},
	[ItemId.Analgetic]: {"Name":"Анальгетик","Description":"Может сделать вас супергероем!","Icon":"inv-item-improvement","Type":"Бафф","Stack":30,"functionType":10},
	[ItemId.Analgin]: {"Name":"Аналгин","Description":"Может сделать вас супергероем!","Icon":"inv-item-improvement","Type":"Бафф","Stack":10,"functionType":10},
	[ItemId.Ibyprofen]: {"Name":"Ибупрофен","Description":"Может сделать вас супергероем!","Icon":"inv-item-improvement","Type":"Бафф","Stack":15,"functionType":10},
	[ItemId.Rod]: { "Name": "Удочка", "Description": "Можно ловить рыбу", "Icon": "inv-item-rod", "Type": "Остальное", "Stack": 1, "functionType": 0 },
	[ItemId.RodUpgraded]: { "Name": "Улучшенная удочка", "Description": "Можно ловить рыбу", "Icon": "inv-item-rod", "Type": "Остальное", "Stack": 1, "functionType": 0 },
	[ItemId.RodMk2]: { "Name": "Удочка MK2", "Description": "Можно ловить рыбу", "Icon": "inv-item-rod", "Type": "Остальное", "Stack": 1, "functionType": 0 },
	[ItemId.Bait]: { "Name": "Наживка", "Description": "С помощью ее можно ловить рыбу", "Icon": "inv-item-bait", "Type": "Остальное", "Stack": 100, "functionType": 0 },
	[ItemId.Sterlad]: { "Name": "Стерлядь", "Description": "Рыба", "Icon": "inv-item-fish", "Type": "Остальное", "Stack": 10, "functionType": 0 },
	[ItemId.Losos]: { "Name": "Лосось", "Description": "Рыба", "Icon": "inv-item-fish", "Type": "Остальное", "Stack": 10, "functionType": 0 },
	[ItemId.Osetr]: { "Name": "Осетр", "Description": "Рыба", "Icon": "inv-item-fish", "Type": "Остальное", "Stack": 10, "functionType": 0 },
	[ItemId.BlackAmur]: { "Name": "Черный амур", "Description": "Рыба", "Icon": "inv-item-fish", "Type": "Остальное", "Stack": 10, "functionType": 0 },
	[ItemId.Skat]: { "Name": "Скат", "Description": "Рыба", "Icon": "inv-item-fish", "Type": "Остальное", "Stack": 10, "functionType": 0 },
	[ItemId.Tunec]: { "Name": "Тунец", "Description": "Рыба", "Icon": "inv-item-fish", "Type": "Остальное", "Stack": 10, "functionType": 0 },
	[ItemId.Malma]: { "Name": "Мальма", "Description": "Рыба", "Icon": "inv-item-fish", "Type": "Остальное", "Stack": 10, "functionType": 0 },
	[ItemId.Fugu]: { "Name": "Фугу", "Description": "Рыба", "Icon": "inv-item-fish", "Type": "Остальное", "Stack": 10, "functionType": 0 },
	[ItemId.Pills]: { "Name": "Пакет таблеток", "Description": "Пакет в котором находится неизвестные таблетки", "Icon": "inv-item-fish", "Type": "Остальное", "Stack": 10, "functionType": 0 },
	[ItemId.Boxmoney]: { "Name": "Кейс с деньгами", "Description": "Кейс, который хранит в себе 10.000.000$", "Icon": "prop_cash_case_02", "Type": "Остальное", "Stack": 30, "functionType": 0 },
	[ItemId.Goldbar]: { "Name": "Слитки золота", "Description": "Обменники ищут слитки золота и могут предложить вам что то интересное в замен", "Icon": "prop_cash_case_02", "Type": "Остальное", "Stack": 30, "functionType": 0 },
	[ItemId.Clipsniper]: { "Name": "Обойма", "Description": "Обойма для снайперской винтовки", "Icon": "w_at_scope_large", "Type": "Остальное", "Stack": 1, "functionType": 0 },
	[ItemId.Sniperscope]: { "Name": "Прицел", "Description": "Прицел для снайперской винтовки", "Icon": "w_at_scope_large", "Type": "Остальное", "Stack": 1, "functionType": 0 },
	[ItemId.Sniperbarrel]: { "Name": "Ствол", "Description": "Ствол для снайперской винтовки", "Icon": "w_at_scope_large", "Type": "Остальное", "Stack": 1, "functionType": 0 },
	[ItemId.SniperCase]: { "Name": "Кейс со снайперской винтовкой", "Description": "Кейс со снайперской винтовкой, в который находится снайперская виновтока Heavy Sniper Mk1", "Icon": "bkr_prop_biker_gcase_s", "Type": "Остальное", "Stack": 1, "functionType": 0 },
	[ItemId.CuponRB]: { "Name": "Купон на RB", "Description": "Купон на донатную валюту в размере 10.000 RB", "Icon": "bkr_prop_biker_gcase_s", "Type": "Остальное", "Stack": 1, "functionType": 0 },
	[ItemId.CuponAC]: { "Name": "Купон на AC", "Description": "Купон на донатную валюту в размере 100 AC", "Icon": "bkr_prop_biker_gcase_s", "Type": "Остальное", "Stack": 1, "functionType": 0 },
	[ItemId.AnimationGift]: { "Name": "Эксклюзивная анимация", "Description": "Данный предмет тебя научит танцевать", "Icon": "bkr_prop_biker_gcase_s", "Type": "Остальное", "Stack": 1, "functionType": 0 },
	[ItemId.SmugglingAC]: { "Name": "Контрабанда", "Description": "Тяжелый кейс, украшенный символам AC, покрытый потертостями, скрывает внутри нелегальные товары", "Icon": "bkr_prop_biker_case_shut", "Type": "Остальное", "Stack": 1, "functionType": 0 },
	[ItemId.SmugglingRB]: { "Name": "Контрабанда", "Description": "Тяжелый кейс, украшенный символам RB, покрытый потертостями, скрывает внутри нелегальные товары", "Icon": "bkr_prop_biker_case_shut", "Type": "Остальное", "Stack": 1, "functionType": 0 },
	[ItemId.SmugglingDollar]: { "Name": "Контрабанда", "Description": "Тяжелый кейс, украшенный символам $, покрытый потертостями, скрывает внутри нелегальные товары.", "Icon": "bkr_prop_biker_case_shut", "Type": "Остальное", "Stack": 1, "functionType": 0 },
	[ItemId.Defibrillator]: { "Name": "Дефибриллятор", "Description": "Поможет оживить человека", "Icon": "bkr_prop_biker_case_shut", "Type":"Остальное","Stack":1,"functionType":0},
	[ItemId.EnergeticLit]: {"Name":"Lit Energy","Description":"Энергетик Lit Energy — идеальный напиток для тех, кто хочет почувствовать прилив энергии и стремительный поток адреналина. Этот напиток подарит вам невероятное ощущение скорости и выносливости, позволяя вам бежать быстрее и дольше, чем когда-либо раньше.","Icon":"inv-item-improvement","Type":"Бафф: Бег","Stack":6,"functionType":10},
	[ItemId.CuponBag]: { "Name": "Купон на Рюкзак", "Description": "Купон на донатный рюкзак", "Icon": "bkr_prop_biker_gcase_s", "Type": "Остальное", "Stack": 1, "functionType": 0 },
}