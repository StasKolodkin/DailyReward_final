export default {
	...
	other: {
		...
		money: {
			//Игрок имеет больше 50.000$ и не владеет домом
		...
		money: {
			//Игрок имеет дом и больше 10.000
	...
	vehicles: {
		...
		key: {
			//Игрок попытался сесть в чужой закрытый транспорт
		...
		seat: {
			//Когда игрок пытается сесть на водительское место фракционного транспорта
	...
	licenses: {
		...
		gun: {
			//Игрок получил лицензию на оружие
