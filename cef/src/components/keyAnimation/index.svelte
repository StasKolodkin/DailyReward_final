...
<div class="KeyAnimation {classData}" class:active={laststate} class:keyDetector={keyDetector} class:keyDonate={keyDonate} class:pressed={state} class:disabled={disabled} class:nonactive={nonactive} on:keypress={() => {}} on:click bind:this={buttonEl} style={style}>
    <slot/>
</div>