...
export const charALVL = writable(0)
window.charStore.charALVL = (value) => charALVL.set(value)
...
export const charTime = writable({
	TotalTime: 0,
	Day: 0,
	TodayTime: 0,
	Month: 0,
...
window.charStore.charTime = (value) => charTime.set(value)
