...
export const accountData = writable(
	JSON.parse(
		'{"Login":"sokolyansky","SocialClub":"Jonatan_Keri","Redbucks":0, "Aquacoins":0,"Vip":0,"VipDate":"2021-08-15T23:17:56","Unique":"packages_9_0","LastSelectCharUUID":0,"Subscribe":false,"charsSlot":[-1,-1,-2,-2,-2,-2,-2,-2,-2],"chars":{}}'
	)
)
//export const accountData = writable({});
...
export const accountAquacoins = writable(0)
window.accountStore.accountAquacoins = (value) => accountAquacoins.set(value)
